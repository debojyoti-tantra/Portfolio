...
const PythonLibrariesComments = () => {
    ...
    const handleCommentSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`/api/learn/pythonLibraries`, {
                comment: comment
                // })
    ...
    const fetchComments = async () => {
        try {
            const { data } = await axios.get(`/api/learn/pythonLibraries`);
...
export default PythonLibrariesComments