...
const page = () => {
   ...
   const handleContactSubmit = (e) => {
      e.preventDefault();
       ...
       emailjs
         .sendForm(process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID, process.env.NEXT_PUBLIC_TEMPLATE_ID, form.current, {
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
               ...
               <form ref={form} onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  <div>
                     ...
                     <input type="hidden" name="user_email" value={user?.primaryEmailAddress?.emailAddress} />
            ...
            <div className="p-6 space-y-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md">
               ...
               <div>
                  ...
                  <div className="flex gap-5">
                     ...
                     <Link href="https://www.linkedin.com/in/debojyoti-tantra-369528343">
                        <LinkedinIcon size={25} />
                     </Link>
                     <Link href="https://x.com/debojyotitantra">
                        <TwitterIcon size={25} />
                     </Link>
                  </div>
               </div>
